...
session_start();
$base_url = 'https://shopacchieudubai.com/'; // Thay url web bạn
class CMSNT
{
    private $ketnoi;
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'rxkdgdra_shopacc', 'rxkdgdra_shopacc', 'rxkdgdra_shopacc') or die ('Vui lòng kết nối đến DATABASE');
