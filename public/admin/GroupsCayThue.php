<?php
    ...
    $title = 'QUẢN LÝ NHÓM CÀY THUÊ | '.$CMSNT->site('tenweb');
...
if(isset($_GET['delete']) && $getUser['level'] == 'admin')
{
    ...
    $isDelete = $CMSNT->remove("groups_caythue", " `id` = '$delete' ");
    if($isDelete)
    {
...
if(isset($_POST['ThemChuyenMuc']) && $getUser['level'] == 'admin' )
{
    ...
    $CMSNT->insert("groups_caythue", array(
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <a type="button" href="<?=BASE_URL('public/admin/CategoryCayThue.php');?>"
                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($CMSNT->get_list(" SELECT * FROM `groups_caythue` WHERE `category` = '".check_string($_GET['id'])."'  ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$i++;?></td>
                                        <td><?=$row['title'];?></td>
